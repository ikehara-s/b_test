...
B. データベースが開かれた後、自動的に実行されます。ただし、リカバリが必要なブロックは、リカバリされるまで使用できません。
...
C. データファイル24は、CDB$ROOTに接続されている間のみリストアできます。
D. データファイル24は、PDB2に接続されている間のみリストアできます。
E. データファイル24は、PDB2に接続している間にリカバリできます。
F. データファイル24は、CDB$ROOTに接続されているときにリカバリできます。
...
D. Oracleは、スキーマをPDBから非CDBに移動するときに、一般的なユーザーを従来のユーザーに変換しようとします。
